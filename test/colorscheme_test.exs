defmodule Colorscheme.TerminalTest do
  ...
  test "converts a color to a red, green and blue value" do
    assert Colorscheme.Terminal.color_to_rgb("BFBFBF") == ~w(0.7490196078 0.7490196078 0.7490196078)
    assert Colorscheme.Terminal.color_to_rgb("A16946") == ~w(0.6313725490 0.4117647059 0.2745098039)
  end
